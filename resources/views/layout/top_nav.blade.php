    ...
    <div class="row border-bottom">
        <nav class="navbar navbar-static-top white-bg" role="navigation" style="margin-bottom: 0">
            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                        <i class="fa fa-language text-navy">&nbsp;</i><strong>زبان <img src="{{asset('dashboard/img/afg.png')}}" width="20px"/>&nbsp;&nbsp;|</strong>
                    </a>
                    <ul class="dropdown-menu dropdown-alerts" style="width: 150px;">
                        ...
                        <a href="#" class="hvr-grow" style="width:100%"><li><img src="{{asset('dashboard/img/un.png')}}" width="20px"/><strong>&nbsp;&nbsp;English</strong></li></a>
                    </ul>
                </li>
